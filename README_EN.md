<div align="center">
  ...
  <p>
    <img alt="Version" src="https://img.shields.io/badge/version-1.0.45-ff5a4f?style=flat-square" />
...
Download the package for your platform from GitHub **Releases**. The current `1.0.45` Windows x64 installers are built by GitHub Actions and signed with the Tauri updater key; they are not Authenticode-signed, so SmartScreen may show an unknown-publisher warning.
